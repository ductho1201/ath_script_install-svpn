...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	echo "Your script version 2 will run automatic without any action."
	echo
	echo "First, your IPv4 address of the network interface is IP which OpenVPN listening to."
	echo ""
	...
	echo
	echo "The protocol used for OpenVPN connections is TCP."
	...
	echo
	echo "Port OpenVPN listening to?"
	PORT=443
